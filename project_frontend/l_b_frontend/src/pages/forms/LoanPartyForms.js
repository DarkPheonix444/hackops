...
const borrowerSections = [
  {
    ...
    fields: [
      ...
      ['name_as_per_aadhaar', 'Name as per Aadhaar', 'text'],
      ['name_as_per_pan', 'Name as per PAN', 'text'],
  ...
  },
  {
    ...
    fields: [
      ['address_line', 'Address Line', 'text', false, 12],
      ['city', 'City', 'text', false, 4],
      ['state', 'State', 'text', false, 4],
      ['pincode', 'PIN Code', 'text', false, 4],
    ],
  },
  {
    ...
    fields: [
      ...
      ['monthly_income', 'Monthly Net Income (₹)', 'number', false, 4],
      ['annual_gross_income', 'Annual Gross Income (₹)', 'number', false, 4],
      [
        'existing_monthly_obligations',
  ...
  },
  {
    ...
    fields: [
      ...
      ['requested_tenure_months', 'Requested Tenure (Months)', 'number', false, 4],
      [
        'repayment_frequency',
        'Repayment Frequency',
        'select',
      ...
      ['loan_purpose', 'Loan Purpose (e.g. Working Capital, Medical, Education)', 'text', false, 12],
      [
        'loan_purpose_details',
